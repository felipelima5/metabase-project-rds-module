...
resource "aws_iam_role" "rds_monitoring_role" {
  name               = "Role-Enhanced-Monitoring-RDS-${random_password.rds_role_name_sufixo.result}"
  path               = "/system/"
...
resource "aws_iam_role_policy" "rds_monitoring_get_policy" {
  name   = "Policy-Enhanced-Monitoring-RDS-${random_password.rds_role_name_sufixo.result}"
